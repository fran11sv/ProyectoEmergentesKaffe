...
<div class="container">
 ...
 <div class="row justify-content-start"> <div class="col-md-auto"><a class="btn btn-primary" href="{{route('productos.create')}}">Agregar Nuevo Producto</a>
 </div>
 </div>
 <div class="card-body">
...
@foreach($productos as $producto)
 ...
 <td>{{ $producto->obtener_categoria->categoria}}</td>
