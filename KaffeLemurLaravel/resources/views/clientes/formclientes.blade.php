<div class="container-fluid">
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="nombre_cli" class="form-control form-control-sm col-sm-4" id="nombre_cli"
                placeholder="Nombres">
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="apellido_cli" class="form-control form-control-sm col-sm-4" id="apellido_cli"
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="email_cli" class="form-control form-control-sm col-sm-4" id="email_cli"
                placeholder="Email">
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="usuario_cli" class="form-control form-control-sm col-sm-4" id="usuario_cli"
                placeholder="Usuario">
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="contra_cli" class="form-control form-control-sm col-sm-4" id="contra_cli"
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="telefono_cli" class="form-control form-control-sm col-sm-4" id="telefono_cli"
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="text" name="direccion_cli" class="form-control form-control-sm col-sm-4" id="direccion_cli"
