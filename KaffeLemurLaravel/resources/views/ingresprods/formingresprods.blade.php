<div class="container-fluid">
    <div class="row">
        <div class="form-group col">
            ...
            <br />
            <select class="form-select col-sm-4" name="id_producto" aria-label="Default select example">
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <br />
            <select class="form-select col-sm-4" name="id_ingrediente" aria-label="Default select example">
